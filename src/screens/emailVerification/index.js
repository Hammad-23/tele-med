      ...
      <SafeAreaView>
        ...
        <View style={styles.headingContainer}>
          ...
          <Text style={styles.smallText}>
            A 4 digit code has been sent to your email. Please check your email
        ...
        <SafeAreaView style={styles.form}>
          <View style={styles.inputs}>
            <OTPInputView
              ...
              onCodeFilled={async code => {
                ...
                let validEmail = JSON.parse(userEmail);
          ...
          <View style={{marginTop: 20}}>
            <Text>
              Did'nt Recieved code? <Text style={styles.boldTxt}>Resend</Text>{' '}
            </Text>
          </View>
        </SafeAreaView>
      </SafeAreaView>
