      ...
      <SafeAreaView>
        ...
        <SafeAreaView style={styles.form}>
          ...
          <View style={{marginTop: 10, width: 310}}>
            <Text>
              By continuing, you agree all the{' '}
              <Text style={styles.boldTxt}> Terms & Conditions</Text>
            </Text>
          </View>
          ...
          <View>
            <Text>
              Existing Doctor? <Text style={styles.boldTxt}>Login</Text>
            </Text>
          </View>
        </SafeAreaView>
      </SafeAreaView>
