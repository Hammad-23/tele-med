...
<View style={styles.txtContainer}>
    ...
    Dr. John Doe, DM cardiology(Gold Medalist) is one of the senior interventional cardiologists. He is highly competent, learned & skilled cardiologist & is a pioneer of radial angiography and has done more than 9000 cardiac procedures till 2016. He is expert in radial angioplasty & stent placement & pacemaker implantations. He is also a consulting cardiologist & echocardiologist.
    </Text>
</View>
...
<View style={styles.txtContainer3}>
    ...
    <Text style={styles.paraTxt}>
    • 2009 - 2010 Interventional & Consultant cardiologist at Escorts Arneja Heart Institute
    </Text>
    <Text style={styles.paraTxt}>
    • 2009 - 2009 Post DM Residency in Cardiology at Post Graduate Institute of Medical Education & Research
    </Text>
    <Text style={styles.paraTxt}>
    • 2010 - 2015 Chief Consultant Cardiologist at Mohak Hitech Hospital
    </Text>
    <Text style={styles.paraTxt}>
    • 2010 - 2015 Chief Consultant Cardiologist at Bhandari Hospital & Research centre
    </Text>
    <Text style={styles.paraTxt}>
    • 2010 - 2015 Associate Professor Cardiology at Sri Aurbindo Institute of Medical Sciences, SAIMS
    </Text>
</View>
